...
$route['book/search'] = 'welcome/search2';
$route['book/search/(:any)'] = 'welcome/search2/$1';
$route['book/search/(:any)/(:num)'] = 'welcome/search2/$1/$2';
//route untuk halaman page
$route['page/(:any)'] = 'welcome/page/$1';
//route untuk URL SEO artikel
$route['(:any)'] = 'welcome/single/$1';
$route['book/(:any)'] = 'welcome/b/$1';
