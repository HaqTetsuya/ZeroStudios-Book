            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        <a href="#" class="dropdown-toggle" data-bs-toggle="collapse" aria-expanded="false" data-bs-target="#componentsMenu" aria-controls="componentsMenu">
                            <i class="menu-icon fa fa-cogs"></i>Components
                        </a>
                        <ul id="componentsMenu" class="sub-menu collapse">
