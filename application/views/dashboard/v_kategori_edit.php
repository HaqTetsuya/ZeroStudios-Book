            ...
            <div class="content-header">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page"><a href="#">edit Kategori</a></li>
                    </ol>
                </nav>
            </div>
            <hr>
                        ...
                        <div class="col-lg-12 connectedSortable">
                            <div class="card card-outline card-info">
                                <div class="card-header d-flex justify-content-between align-items-center">
                                    <h3 class="card-title">
                                        <i class="nav-icon fas fa-th"></i> Data Kategori |<small> Edit Kategori | </small>
                                    </h3>
                                    ...
                                    ?>
                                        <form method="post" action="<?php echo base_url('dashboard/kategori_update'); ?>">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="kategori" class="form-control" placeholder="Masukan Nama Kategori . . . " value="<?php echo $k->kategori_nama; ?>" required>
